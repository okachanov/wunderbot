...
export const instructionsMessage = `Now you can add tasks to your inbox by sending or forwarding messages to this chat
                                      For better experience, add this chat to pinned`;
export const taskAddedMessage = `Task created`;
export const taskErrorMessage = `Something went wrong. Task don't created`;